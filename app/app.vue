...
const noodleTypes = ref(['เส้นเล็ก', 'เส้นใหญ่', 'เส้นหมี่', 'บะหมี่', 'วุ้นเส้น', 'เกาเหลา','เส้นเหลือง','มาม่า']);
...
const showTableSelection = ref(false); // State สำหรับเปิด/ปิด Modal เลือกโต๊ะ
...
// --- State และฟังก์ชันสำหรับ Modal แจ้งเตือน ---
...
// ===== START: ฟังก์ชันใหม่สำหรับเลือกโต๊ะ =====
/**
 * อัปเดตหมายเลขโต๊ะและปิด Modal
 * @param {number} newTableNumber - หมายเลขโต๊ะที่เลือก
 */
function selectTable(newTableNumber) {
  tableNumber.value = newTableNumber;
  showTableSelection.value = false;
}
// ===== END: ฟังก์ชันใหม่สำหรับเลือกโต๊ะ =====
